...
const EditProductForm: React.FC<EditProductFormProps> = ({
	...
	const categoriesList = apiCategories.map((cat) => ({
		id: cat._id,
		name: cat.name,
	}));
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			const updatedProduct = {
				...
				reviews: product.reviews, // Preserve original reviews array
			};
							...
							<div>
								...
								<div className='space-y-3'>
									...
									<p className='text-sm text-gray-500'>
										Add one or more image URLs. Press Enter or click Add to
										include each image.
									</p>
									{errors.images && (
