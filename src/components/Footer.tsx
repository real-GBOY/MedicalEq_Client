...
import { Activity, Facebook, Twitter, Linkedin, Instagram, Mail, Phone, MapPin } from 'lucide-react';
...
const Footer: React.FC = () => {
  ...
  const products = [
    { name: 'MRI Scanners', href: '#' },
    { name: 'X-Ray Systems', href: '#' },
    { name: 'Ultrasound', href: '#' },
    { name: 'Patient Monitors', href: '#' }
  ];
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          >
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              ...
              empowering healthcare professionals worldwide with cutting-edge technology.
            </p>
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">123 Healthcare Blvd, NY 10001</span>
              </div>
            </div>
          </motion.div>
